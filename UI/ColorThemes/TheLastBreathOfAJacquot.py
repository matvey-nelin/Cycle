...
class TheLastBreathOfAJacquot:
    def __init__(self) -> None:
        """Цвета для тёмной версии темы 'Последний вздох жако'"""

        # === ОСНОВНАЯ ПАЛИТРА (для кнопок действий) ===
        self.DARK_PRIMARY = ft.Colors.RED_400
        self.DARK_PRIMARY_CONTAINER = ft.Colors.RED_300
        ...
        self.DARK_SECONDARY_CONTAINER = ft.Colors.GREY_300
        ...
        self.DARK_ON_SURFACE = ft.Colors.GREY_50
        self.DARK_SURFACE_TINT = ft.Colors.RED_400
        self.DARK_BACKGROUND = ft.Colors.GREY_900
        self.DARK_ON_BACKGROUND = ft.Colors.GREY_50
        
        # === СТАТУСЫ ===
        self.DARK_ERROR = ft.Colors.RED_500
        self.DARK_ERROR_CONTAINER = ft.Colors.RED_400
        ...
        """Цвета для светлой версии темы 'Последний вздох жако'"""

        # === ОСНОВНАЯ ПАЛИТРА (для кнопок действий) ===
        self.LIGHT_PRIMARY = ft.Colors.RED_600
        self.LIGHT_PRIMARY_CONTAINER = ft.Colors.RED_500
        self.LIGHT_ON_PRIMARY = ft.Colors.WHITE
        self.LIGHT_ON_PRIMARY_CONTAINER = ft.Colors.RED_100
        
        self.LIGHT_SECONDARY = ft.Colors.GREY_600
        self.LIGHT_SECONDARY_CONTAINER = ft.Colors.GREY_500
        self.LIGHT_ON_SECONDARY = ft.Colors.WHITE
        self.LIGHT_ON_SECONDARY_CONTAINER = ft.Colors.GREY_100
        
        self.LIGHT_TERTIARY = ft.Colors.GREY_800
        self.LIGHT_TERTIARY_CONTAINER = ft.Colors.GREY_700
        self.LIGHT_ON_TERTIARY = ft.Colors.WHITE
        self.LIGHT_ON_TERTIARY_CONTAINER = ft.Colors.GREY_200
        
        # === ФОН И ПОВЕРХНОСТИ ===
        self.LIGHT_SURFACE = ft.Colors.WHITE
        self.LIGHT_ON_SURFACE = ft.Colors.GREY_900
        self.LIGHT_SURFACE_TINT = ft.Colors.RED_600
        self.LIGHT_BACKGROUND = ft.Colors.GREY_100
        self.LIGHT_ON_BACKGROUND = ft.Colors.GREY_900
        
        # === СТАТУСЫ ===
        self.LIGHT_ERROR = ft.Colors.RED_700
        self.LIGHT_ERROR_CONTAINER = ft.Colors.RED_600
        self.LIGHT_ON_ERROR = ft.Colors.WHITE
        self.LIGHT_ON_ERROR_CONTAINER = ft.Colors.RED_200
