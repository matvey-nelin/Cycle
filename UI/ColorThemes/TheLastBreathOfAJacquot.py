...
class TheLastBreathOfAJacquot:
    def __init__(self) -> None:
        
        # ==========================================
        # ТЁМНАЯ ТЕМА (TheLastBreathOfAJacquot - Серый сумрак)
        # ==========================================
        
        # --- Основные акценты (Алый, Белый, Графит) ---
        self.DARK_PRIMARY =                     ft.Colors.RED_400
        self.DARK_ON_PRIMARY =                  "#141010"
        self.DARK_PRIMARY_CONTAINER =           ft.Colors.RED_800
        self.DARK_ON_PRIMARY_CONTAINER =        ft.Colors.RED_100
        self.DARK_PRIMARY_FIXED =               ft.Colors.RED_700
        self.DARK_PRIMARY_FIXED_DIM =           ft.Colors.RED_800
        self.DARK_ON_PRIMARY_FIXED =            "#141010"
        self.DARK_ON_PRIMARY_FIXED_VARIANT =    "#2A1818"
        
        self.DARK_SECONDARY =                   ft.Colors.GREY_400
        self.DARK_ON_SECONDARY =                "#141010"
        self.DARK_SECONDARY_CONTAINER =         ft.Colors.GREY_800
        self.DARK_ON_SECONDARY_CONTAINER =      ft.Colors.GREY_100
        self.DARK_SECONDARY_FIXED =             ft.Colors.GREY_700
        self.DARK_SECONDARY_FIXED_DIM =         ft.Colors.GREY_800
        self.DARK_ON_SECONDARY_FIXED =          "#141010"
        self.DARK_ON_SECONDARY_FIXED_VARIANT =  "#1E1C1C"
        
        self.DARK_TERTIARY =                    ft.Colors.WHITE
        self.DARK_ON_TERTIARY =                 "#141010"
        self.DARK_TERTIARY_CONTAINER =          ft.Colors.GREY_200
        self.DARK_ON_TERTIARY_CONTAINER =       ft.Colors.GREY_900
        self.DARK_TERTIARY_FIXED =              ft.Colors.GREY_700
        self.DARK_TERTIARY_FIXED_DIM =          ft.Colors.GREY_800
        self.DARK_ON_TERTIARY_FIXED =           "#141010"
        self.DARK_ON_TERTIARY_FIXED_VARIANT =   "#1E1C1C"
        
        # --- Ошибки ---
        self.DARK_ERROR =                       ft.Colors.RED_500
        self.DARK_ON_ERROR =                    "#141010"
        self.DARK_ERROR_CONTAINER =             ft.Colors.RED_800
        self.DARK_ON_ERROR_CONTAINER =          ft.Colors.RED_100
        
        # --- Поверхности (Угольный графит) ---
        self.DARK_SURFACE =                     "#141212"
        self.DARK_ON_SURFACE =                  "#E6E1E5"
        self.DARK_ON_SURFACE_VARIANT =          "#C4C7C5"
        self.DARK_SURFACE_TINT =                ft.Colors.RED_400
        
        self.DARK_SURFACE_DIM =                 "#0C0A0A"
        self.DARK_SURFACE_BRIGHT =              "#2E2A2A"
        self.DARK_SURFACE_CONTAINER_LOWEST =    "#100E0E"
        self.DARK_SURFACE_CONTAINER_LOW =       "#141212"
        self.DARK_SURFACE_CONTAINER =           "#181616"
        self.DARK_SURFACE_CONTAINER_HIGH =      "#1E1C1C"
        self.DARK_SURFACE_CONTAINER_HIGHEST =   "#252323"
        
        # --- Границы, Инверсия, Тени ---
        self.DARK_OUTLINE =                     "#938F99"
        self.DARK_OUTLINE_VARIANT =             "#49454F"
        self.DARK_SHADOW =                      "#140808"
        self.DARK_SCRIM =                       "#000000"
        self.DARK_INVERSE_SURFACE =             "#E6E1E5"
        self.DARK_ON_INVERSE_SURFACE =          "#141010"
        self.DARK_INVERSE_PRIMARY =             ft.Colors.RED_700
        ...
        # ==========================================
        # СВЕТЛАЯ ТЕМА (TheLastBreathOfAJacquot - Бумажный свет)
        # ==========================================
        
        # --- Основные акценты ---
        self.LIGHT_PRIMARY =                    ft.Colors.RED_600
        self.LIGHT_ON_PRIMARY =                 ft.Colors.WHITE
        self.LIGHT_PRIMARY_CONTAINER =          ft.Colors.RED_100
        self.LIGHT_ON_PRIMARY_CONTAINER =       ft.Colors.RED_900
        self.LIGHT_PRIMARY_FIXED =              ft.Colors.RED_700
        self.LIGHT_PRIMARY_FIXED_DIM =          ft.Colors.RED_800
        self.LIGHT_ON_PRIMARY_FIXED =           "#141010"
        self.LIGHT_ON_PRIMARY_FIXED_VARIANT =   "#2A1818"
        
        self.LIGHT_SECONDARY =                  ft.Colors.GREY_600
        self.LIGHT_ON_SECONDARY =               ft.Colors.WHITE
        self.LIGHT_SECONDARY_CONTAINER =        ft.Colors.GREY_100
        self.LIGHT_ON_SECONDARY_CONTAINER =     ft.Colors.GREY_900
        self.LIGHT_SECONDARY_FIXED =            ft.Colors.GREY_700
        self.LIGHT_SECONDARY_FIXED_DIM =        ft.Colors.GREY_800
        self.LIGHT_ON_SECONDARY_FIXED =         "#141010"
        self.LIGHT_ON_SECONDARY_FIXED_VARIANT = "#1E1C1C"
        
        self.LIGHT_TERTIARY =                   ft.Colors.GREY_800
        self.LIGHT_ON_TERTIARY =                ft.Colors.WHITE
        self.LIGHT_TERTIARY_CONTAINER =         ft.Colors.GREY_200
        self.LIGHT_ON_TERTIARY_CONTAINER =      ft.Colors.GREY_900
        self.LIGHT_TERTIARY_FIXED =             ft.Colors.GREY_700
        self.LIGHT_TERTIARY_FIXED_DIM =         ft.Colors.GREY_800
        self.LIGHT_ON_TERTIARY_FIXED =          "#141010"
        self.LIGHT_ON_TERTIARY_FIXED_VARIANT =  "#1E1C1C"
        
        # --- Ошибки ---
        self.LIGHT_ERROR =                      ft.Colors.RED_700
        self.LIGHT_ON_ERROR =                   ft.Colors.WHITE
        self.LIGHT_ERROR_CONTAINER =            ft.Colors.RED_200
        self.LIGHT_ON_ERROR_CONTAINER =         ft.Colors.RED_900
        
        # --- Поверхности (Чистый пергамент) ---
        self.LIGHT_SURFACE =                    "#FCFAFA"
        self.LIGHT_ON_SURFACE =                 "#1D1B20"
        self.LIGHT_ON_SURFACE_VARIANT =         "#49454F"
        self.LIGHT_SURFACE_TINT =               ft.Colors.RED_600
        
        self.LIGHT_SURFACE_DIM =                "#E2DFDF"
        self.LIGHT_SURFACE_BRIGHT =             "#FCFAFA"
        self.LIGHT_SURFACE_CONTAINER_LOWEST =   "#FFFFFF"
        self.LIGHT_SURFACE_CONTAINER_LOW =      "#F4F2F2"
        self.LIGHT_SURFACE_CONTAINER =          "#ECEAEA"
        self.LIGHT_SURFACE_CONTAINER_HIGH =     "#E4E2E2"
        self.LIGHT_SURFACE_CONTAINER_HIGHEST =  "#DCDADA"
        
        # --- Границы, Инверсия, Тени ---
        self.LIGHT_OUTLINE =                    "#79747E"
        self.LIGHT_OUTLINE_VARIANT =            "#CAC4D0"
        self.LIGHT_SHADOW =                     "#2A1818"
        self.LIGHT_SCRIM =                      "#000000"
        self.LIGHT_INVERSE_SURFACE =            "#322F35"
        self.LIGHT_ON_INVERSE_SURFACE =         "#F5EFF7"
        self.LIGHT_INVERSE_PRIMARY =            ft.Colors.RED_200
