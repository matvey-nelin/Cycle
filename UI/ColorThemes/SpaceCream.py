...
class SpaceCream:
    def __init__(self) -> None:
        """Цвета для тёмной версии темы 'Космические сливки'"""

        # === ОСНОВНАЯ ПАЛИТРА (для кнопок действий) ===
        self.DARK_PRIMARY = ft.Colors.PURPLE_300
        self.DARK_PRIMARY_CONTAINER = ft.Colors.PURPLE_200
        ...
        self.DARK_SECONDARY_CONTAINER = ft.Colors.PINK_200
        ...
        self.DARK_TERTIARY_CONTAINER = ft.Colors.CYAN_200
        ...
        self.DARK_ON_SURFACE = ft.Colors.PURPLE_50
        self.DARK_SURFACE_TINT = ft.Colors.PURPLE_300
        self.DARK_BACKGROUND = ft.Colors.GREY_900
        self.DARK_ON_BACKGROUND = ft.Colors.PURPLE_50
        ...
        self.DARK_WARNING = ft.Colors.AMBER_300
        ...
        """Цвета для светлой версии темы 'Космические сливки'"""

        # === ОСНОВНАЯ ПАЛИТРА (для кнопок действий) ===
        self.LIGHT_PRIMARY = ft.Colors.PURPLE_500
        self.LIGHT_PRIMARY_CONTAINER = ft.Colors.PURPLE_400
        self.LIGHT_ON_PRIMARY = ft.Colors.WHITE
        self.LIGHT_ON_PRIMARY_CONTAINER = ft.Colors.PURPLE_100
        
        self.LIGHT_SECONDARY = ft.Colors.PINK_500
        self.LIGHT_SECONDARY_CONTAINER = ft.Colors.PINK_400
        self.LIGHT_ON_SECONDARY = ft.Colors.WHITE
        self.LIGHT_ON_SECONDARY_CONTAINER = ft.Colors.PINK_100
        
        self.LIGHT_TERTIARY = ft.Colors.CYAN_500
        self.LIGHT_TERTIARY_CONTAINER = ft.Colors.CYAN_400
        self.LIGHT_ON_TERTIARY = ft.Colors.WHITE
        self.LIGHT_ON_TERTIARY_CONTAINER = ft.Colors.CYAN_100
        
        # === ФОН И ПОВЕРХНОСТИ ===
        self.LIGHT_SURFACE = ft.Colors.WHITE
        self.LIGHT_ON_SURFACE = ft.Colors.GREY_900
        self.LIGHT_SURFACE_TINT = ft.Colors.PURPLE_500
        self.LIGHT_BACKGROUND = ft.Colors.PURPLE_50
        ...
        self.LIGHT_WARNING = ft.Colors.AMBER_500
        self.LIGHT_ON_WARNING = ft.Colors.WHITE
        
        # === ГРАНИЦЫ ===
        self.LIGHT_OUTLINE = ft.Colors.PURPLE_200
        self.LIGHT_OUTLINE_VARIANT = ft.Colors.PURPLE_100
