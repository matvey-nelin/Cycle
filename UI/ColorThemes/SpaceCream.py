...
class SpaceCream:
    def __init__(self) -> None:
        ...
        # ==========================================
        # ТЁМНАЯ ТЕМА (SpaceCream - Туманность)
        # ==========================================
        
        # --- Основные акценты (Фиолет, Розовый, Циан) ---
        self.DARK_PRIMARY =                     ft.Colors.PURPLE_300
        self.DARK_ON_PRIMARY =                  "#100A12"
        self.DARK_PRIMARY_CONTAINER =           ft.Colors.PURPLE_800
        self.DARK_ON_PRIMARY_CONTAINER =        ft.Colors.PURPLE_100
        self.DARK_PRIMARY_FIXED =               ft.Colors.PURPLE_700
        self.DARK_PRIMARY_FIXED_DIM =           ft.Colors.PURPLE_800
        self.DARK_ON_PRIMARY_FIXED =            "#100A12"
        self.DARK_ON_PRIMARY_FIXED_VARIANT =    "#281A2C"
        
        self.DARK_SECONDARY =                   ft.Colors.PINK_300
        self.DARK_ON_SECONDARY =                "#100A12"
        self.DARK_SECONDARY_CONTAINER =         ft.Colors.PINK_800
        self.DARK_ON_SECONDARY_CONTAINER =      ft.Colors.PINK_100
        self.DARK_SECONDARY_FIXED =             ft.Colors.PINK_700
        self.DARK_SECONDARY_FIXED_DIM =         ft.Colors.PINK_800
        self.DARK_ON_SECONDARY_FIXED =          "#100A12"
        self.DARK_ON_SECONDARY_FIXED_VARIANT =  "#2C1A24"
        
        self.DARK_TERTIARY =                    ft.Colors.CYAN_300
        self.DARK_ON_TERTIARY =                 "#100A12"
        self.DARK_TERTIARY_CONTAINER =          ft.Colors.CYAN_800
        self.DARK_ON_TERTIARY_CONTAINER =       ft.Colors.CYAN_100
        self.DARK_TERTIARY_FIXED =              ft.Colors.CYAN_700
        self.DARK_TERTIARY_FIXED_DIM =          ft.Colors.CYAN_800
        self.DARK_ON_TERTIARY_FIXED =           "#100A12"
        self.DARK_ON_TERTIARY_FIXED_VARIANT =   "#1A2628"
        
        # --- Ошибки ---
        self.DARK_ERROR =                       ft.Colors.RED_400
        self.DARK_ON_ERROR =                    "#100A12"
        self.DARK_ERROR_CONTAINER =             ft.Colors.RED_800
        self.DARK_ON_ERROR_CONTAINER =          ft.Colors.RED_100
        
        # --- Поверхности (Глубокий космос) ---
        self.DARK_SURFACE =                     "#120D14"
        self.DARK_ON_SURFACE =                  "#E6E1E5"
        self.DARK_ON_SURFACE_VARIANT =          "#C4C7C5"
        self.DARK_SURFACE_TINT =                ft.Colors.PURPLE_300
        
        self.DARK_SURFACE_DIM =                 "#0A060C"
        self.DARK_SURFACE_BRIGHT =              "#2A242C"
        self.DARK_SURFACE_CONTAINER_LOWEST =    "#0E0910"
        self.DARK_SURFACE_CONTAINER_LOW =       "#120D14"
        self.DARK_SURFACE_CONTAINER =           "#161118"
        self.DARK_SURFACE_CONTAINER_HIGH =      "#1C171E"
        self.DARK_SURFACE_CONTAINER_HIGHEST =   "#231E25"
        
        # --- Границы, Инверсия, Тени ---
        self.DARK_OUTLINE =                     "#938F99"
        self.DARK_OUTLINE_VARIANT =             "#49454F"
        self.DARK_SHADOW =                      "#0A0510"
        self.DARK_SCRIM =                       "#000000"
        self.DARK_INVERSE_SURFACE =             "#E6E1E5"
        self.DARK_ON_INVERSE_SURFACE =          "#100A12"
        self.DARK_INVERSE_PRIMARY =             ft.Colors.PURPLE_700
        ...
        # ==========================================
        # СВЕТЛАЯ ТЕМА (SpaceCream - Млечный путь)
        # ==========================================
        
        # --- Основные акценты ---
        self.LIGHT_PRIMARY =                    ft.Colors.PURPLE_600
        self.LIGHT_ON_PRIMARY =                 ft.Colors.WHITE
        self.LIGHT_PRIMARY_CONTAINER =          ft.Colors.PURPLE_100
        self.LIGHT_ON_PRIMARY_CONTAINER =       ft.Colors.PURPLE_900
        self.LIGHT_PRIMARY_FIXED =              ft.Colors.PURPLE_700
        self.LIGHT_PRIMARY_FIXED_DIM =          ft.Colors.PURPLE_800
        self.LIGHT_ON_PRIMARY_FIXED =           "#100A12"
        self.LIGHT_ON_PRIMARY_FIXED_VARIANT =   "#281A2C"
        ...
        self.LIGHT_SECONDARY_FIXED =            ft.Colors.PINK_700
        self.LIGHT_SECONDARY_FIXED_DIM =        ft.Colors.PINK_800
        self.LIGHT_ON_SECONDARY_FIXED =         "#100A12"
        self.LIGHT_ON_SECONDARY_FIXED_VARIANT = "#2C1A24"
        
        self.LIGHT_TERTIARY =                   ft.Colors.CYAN_600
        self.LIGHT_ON_TERTIARY =                ft.Colors.WHITE
        self.LIGHT_TERTIARY_CONTAINER =         ft.Colors.CYAN_100
        self.LIGHT_ON_TERTIARY_CONTAINER =      ft.Colors.CYAN_900
        self.LIGHT_TERTIARY_FIXED =             ft.Colors.CYAN_700
        self.LIGHT_TERTIARY_FIXED_DIM =         ft.Colors.CYAN_800
        self.LIGHT_ON_TERTIARY_FIXED =          "#100A12"
        self.LIGHT_ON_TERTIARY_FIXED_VARIANT =  "#1A2628"
        ...
        # --- Поверхности (Небесная ваниль) ---
        self.LIGHT_SURFACE =                    "#F9F5FA"
        self.LIGHT_ON_SURFACE =                 "#1D1B20"
        self.LIGHT_ON_SURFACE_VARIANT =         "#49454F"
        self.LIGHT_SURFACE_TINT =               ft.Colors.PURPLE_600
        
        self.LIGHT_SURFACE_DIM =                "#DDD5DF"
        self.LIGHT_SURFACE_BRIGHT =             "#F9F5FA"
        self.LIGHT_SURFACE_CONTAINER_LOWEST =   "#FFFFFF"
        self.LIGHT_SURFACE_CONTAINER_LOW =      "#F1EBF2"
        self.LIGHT_SURFACE_CONTAINER =          "#E9E3EA"
        self.LIGHT_SURFACE_CONTAINER_HIGH =     "#E1DBE2"
        self.LIGHT_SURFACE_CONTAINER_HIGHEST =  "#D9D3DA"
        
        # --- Границы, Инверсия, Тени ---
        self.LIGHT_OUTLINE =                    "#79747E"
        self.LIGHT_OUTLINE_VARIANT =            "#CAC4D0"
        self.LIGHT_SHADOW =                     "#281A2C"
        self.LIGHT_SCRIM =                      "#000000"
        self.LIGHT_INVERSE_SURFACE =            "#322F35"
        self.LIGHT_ON_INVERSE_SURFACE =         "#F5EFF7"
        self.LIGHT_INVERSE_PRIMARY =            ft.Colors.PURPLE_200
