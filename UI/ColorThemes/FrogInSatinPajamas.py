...
class FrogInSatinPajamas:
    def __init__(self) -> None:
        """Цвета для тёмной версии темы 'Лягушка в атласной пижаме'"""

        # === ОСНОВНАЯ ПАЛИТРА (для кнопок действий) ===
        self.DARK_PRIMARY = ft.Colors.LIME_400
        self.DARK_PRIMARY_CONTAINER = ft.Colors.LIME_300
        ...
        """Цвета для светлой версии темы 'Лягушка в атласной пижаме'"""

        # === ОСНОВНАЯ ПАЛИТРА (для кнопок действий) ===
        self.LIGHT_PRIMARY = ft.Colors.LIME_600
        self.LIGHT_PRIMARY_CONTAINER = ft.Colors.LIME_500
        self.LIGHT_ON_PRIMARY = ft.Colors.WHITE
        self.LIGHT_ON_PRIMARY_CONTAINER = ft.Colors.LIME_100
        ...
        self.LIGHT_SURFACE_TINT = ft.Colors.LIME_600
        self.LIGHT_BACKGROUND = ft.Colors.LIME_50
