...
class AgonistsScreen(BaseView):
    def __init__(self, page: ft.Page, navigate_callback, app_state: AppState, previous_screen_name: str | None = None):
        ...
        self.labels = self.translator.agonists_screen_labels
    ...
    def _init_data_(self):
        records_list = RecordsList(self.page, self.app_state, "agonists", self.navigate)
    ...
    def open_record_screen(self):
        self.navigate(
            screen_name=            "agonist_management_screen",
