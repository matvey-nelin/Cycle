...
class HypertrophyTypesScreen(BaseView):
    def __init__(self, page: ft.Page, navigate_callback, app_state: AppState, previous_screen_name: str | None = None):
        ...
        self.labels = self.translator.hypertrophy_types_screen_labels
    ...
    def _init_data_(self):
        records_list = RecordsList(self.page, self.app_state, "hypertrophy_types", self.navigate)
    ...
    def open_record_screen(self):
        self.navigate(
            screen_name=            "universal_record_management_screen",
