...
class WorkoutStatusesScreen(BaseView):
    def __init__(self, page: ft.Page, navigate_callback, app_state: AppState, previous_screen_name: str | None = None):
        ...
        self.labels = self.translator.workout_statuses_screen_labels
    ...
    def _init_data_(self):
        records_list = RecordsList(self.page, self.app_state, "workout_statuses", self.navigate)
