...
- 📈 Графики прогресса (рабочий вес, объём, частота тренировок)
...
> 💡 Замените ссылки на реальные скриншоты. Рекомендуемый размер: `800x600` или `1280x720`.

## 🚀 Установка и запуск

### 1. Клонирование репозитория
```bash
git clone https://github.com/твой-ник/workout-diary.git
cd workout-diary
